...
xxxx is based on xxxx model driven by xxx inputs and xxdriversxx provided
by user as inputs to the component. For each node, component simulates xxxx as
well as xxx based on xxxx.
...
class NetworkBedloadMorphodynamic(Component):
    """Network bedload morphodynamic component.

    Landlab component designed to calculate _____.
    The _____ is provided by the user in the form of ___; __ options for
    ____ are supported.
    The model uses _____ characteristics provided as input by the user.
    The main method of the NetworkBedloadMorphodynamic class is
    something_something(), which calculates ________, probability of soil
    saturation.
...
# AP note: this is where the documentation ends and the component starts...
    ...
    # component name
    _name = 'NetworkBedloadMorphodynamic'
    __version__ = '1.0'
